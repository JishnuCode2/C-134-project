...
train_data = pd.read_csv("./C134-project/static/assets/dataset/updated_product_dataset.csv")  
...
model = load_model("./C134-project/static/assets/model/Text_Emotion.h5")
